...
- [x] T20. **PF2e Item — "Whisperbell charm"** — a small silver bell charm that lets the wearer send a short silent message to one ally within earshot once per day.
- [ ] T21. **PF2e Store — "Tideglass apothecary"** — a coastal shop stocking salt-cured reagents, sea-remedies, and preserved catches for sailors and dockhands.
