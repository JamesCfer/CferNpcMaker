...
export const ALL_MODULES = [
  ...
  },
  {
    ...
    system:      'pf2e',
    label:       'Pathfinder 2e Store',
    icon:        'fa-solid fa-shop',
    accentClass: 'card--pf2estore',
    description: 'Generate a single PF2e shop with owner, staff, hours and priced stock.',
  ...
  },
  {
    ...
    description: 'Generate a single D&D 5e shop with owner, staff, hours and priced stock.',
